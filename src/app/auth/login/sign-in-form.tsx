...
import { LoginData, loginSchema } from "../schemas-types";
...
export default function SignInForm() {
  ...
  return (
    <div className="flex justify-center items-center min-h-[70vh] p-3">
      <div className="flex flex-col justify-center items-center p-8 border max-w-[40rem] w-[90%] rounded-lg space-y-3 md:space-y-5 text-xl">
        <h2 className="text-lg lg:text-4xl">Sign in</h2>
        <form
          onSubmit={handleSubmit(onSubmit)}
          className="space-y-2 md:space-y-4 text-sm w-[80%]"
        >
